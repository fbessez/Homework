  ...
  *)
  and inferExp (G : env) (e : Ast.exp) : AnnAst.exp =
    case e of
       ...
       | Ast.ELt(e0, e1) => inferBinRel G e0 e1 AnnAst.ELt
       | Ast.ELe(e0, e1) => inferBinRel G e0 e1 AnnAst.ELe
       | Ast.EGt(e0, e1) => inferBinRel G e0 e1 AnnAst.EGt
       | Ast.EGe(e0, e1) => inferBinRel G e0 e1 AnnAst.EGe
